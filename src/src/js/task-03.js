...
galeryContainerEl.insertAdjacentHTML("afterbegin", makeGalery);
 galeryContainerEl.style.display = 'flex'
 galeryContainerEl.style.flexWrap = 'wrap'
 galeryContainerEl.style.gap = '10px'
 galeryContainerEl.style.justifyContent = 'center'